 ...
 return (
  <>
   {projects.map((project, index) => (
    <article key={project.slug} className="grid border-b rule-border last:border-b-0 sm:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
     ...
     <div className="grid grid-cols-[4ch_1fr] gap-[var(--space-gap)] p-[var(--space-page)]">
      ...
      <div>
       ...
       <p className="type-caption mt-[calc(var(--space-gap)*0.75)] max-w-[32rem] break-keep text-black/70">{project.description}</p>
      </div>
     </div>
    </article>
   ))}
